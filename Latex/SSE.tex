...
\begin{figure}[thb]
  \centering
  \includegraphics[width=0.4\textwidth]{Bilder/Vertizes}
  \caption[Mögliche Verwendung der Operatoren mit den Typnummern der Vertizes; {\itshape Quelle:} \cite{Sandvik}]{{\bfseries Mögliche Verwendung der Operatoren mit den Typnummern der Vertizes}; {\itshape Quelle:} \cite{Sandvik}}
  \label{fig:Vertizes}
\end{figure}
...
\begin{figure}[bth]
  ...
  \subfloat[{\bfseries Mittelwerte der Energie}]{
    ...
    \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Ketten_Energie-Temperatur} 
  }
  \subfloat[{\bfseries Mittelwerte der Wärmekapazität}]{
    \label{fig:KettenWaermekapazitaetTemperatur}
    \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Ketten_Waermekapazitaet-Temperatur} 
  }
...
\begin{figure}
  \centering
  \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Ketten_FehlerEnergie-Temperatur} 
...
\begin{figure}[bh]
  ...
  \subfloat[{\bfseries Mittelwerte der Energie}]{
    ...
    \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Gitter_Energie-Temperatur} 
  }
  \subfloat[{\bfseries Mittelwerte der Wärmekapazität}]{
    \label{fig:GitterWaermekapazitaetTemperatur}
    \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Gitter_Waermekapazitaet-Temperatur} 
  }
...
\begin{figure}[bh]
  ...
  \subfloat[{\bfseries Mittelwerte der Energie}]{
    ...
    \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Alle_Energie-Temperatur} 
  }
  \subfloat[{\bfseries Mittelwerte der Wärmekapazität}]{
    \label{fig:AlleWaermekapazitaetTemperatur}
    \includegraphics[width=0.48\textwidth]{Diagramme/SSE/Alle_Waermekapazitaet-Temperatur} 
  }
