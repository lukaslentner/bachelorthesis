...
set ylabel "Energie pro Spin E/N [J]"
plot "../../../Code/Analysis/ED/4-Open1D/Data" using 5:6 lt rgb "#000000" with lines title "ED 4er Kette offen", \
"../../../Code/Analysis/SSE/4-Open1D/Data" using 5:6 lt rgb "#FF0000" with lines title "SSE 4er Kette offen", \
"../../../Code/Analysis/ED/4-Periodic1D/Data" using 5:6 lt rgb "#000000" with lines title "ED 4er Kette periodisch", \
"../../../Code/Analysis/SSE/4-Periodic1D/Data" using 5:6 lt rgb "#00FF00" with lines title "SSE 4er Kette periodisch", \
"../../../Code/Analysis/ED/4-Periodic2D/Data" using 5:6 lt rgb "#000000" with lines title "ED 2x2 Gitter periodisch", \
"../../../Code/Analysis/SSE/4-Periodic2D/Data" using 5:6 lt rgb "#0000FF" with lines title "SSE 2x2 Gitter periodisch"
!epstopdf Alle_Energie-Temperatur.eps && rm Alle_Energie-Temperatur.eps

set key right top
set output "Alle_Waermekapazitaet-Temperatur.eps"
set ylabel "Wärmekapazität pro Spin C/N [1]"
plot "../../../Code/Analysis/ED/4-Open1D/Data" using 5:9 lt rgb "#000000" with lines title "ED 4er Kette offen", \
"../../../Code/Analysis/SSE/4-Open1D/Data" using 5:9 lt rgb "#FF0000" with lines title "SSE 4er Kette offen", \
"../../../Code/Analysis/ED/4-Periodic1D/Data" using 5:9 lt rgb "#000000" with lines title "ED 4er Kette periodisch", \
"../../../Code/Analysis/SSE/4-Periodic1D/Data" using 5:9 lt rgb "#00FF00" with lines title "SSE 4er Kette periodisch", \
"../../../Code/Analysis/ED/4-Periodic2D/Data" using 5:9 lt rgb "#000000" with lines title "ED 2x2 Gitter periodisch", \
"../../../Code/Analysis/SSE/4-Periodic2D/Data" using 5:9 lt rgb "#0000FF" with lines title "SSE 2x2 Gitter periodisch"
